...
<div class="container-fluid">
  <div class="card card-body py-3">
    <div class="d-sm-flex align-items-center justify-space-between">
      <h4 class="mb-0 card-title">Sản phẩm thuộc thương hiệu: {{ $trademark->name }}</h4>
      <div class="d-flex gap-2">
        <a href="{{ route('catalog_v1.trademarks.attach.page',$trademark->id) }}" class="btn btn-info">Thêm sản phẩm</a>
  ...
  <div class="card">
    <div class="card-body">
      <form method="get" class="row" action="{{ route('catalog_v1.trademarks.products',$trademark->id) }}">
        ...
        <div class="col-md-4 mb-2">
          ...
          <a class="btn btn-danger" href="{{ route('catalog_v1.trademarks.products',$trademark->id) }}">Hủy</a>
        </div>
      </form>

      <form method="post" action="{{ route('catalog_v1.trademarks.detach',$trademark->id) }}" id="detachForm">
        @csrf
        ...
        <button class="btn btn-danger">Gỡ sản phẩm khỏi thương hiệu</button>
      </form>
