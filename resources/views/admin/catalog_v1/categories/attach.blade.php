...
<div class="container-fluid">
  <div class="card card-body py-3">
    <div class="d-sm-flex align-items-center justify-space-between">
      <h4 class="mb-0 card-title">Thêm sản phẩm vào danh mục: {{ $category->name }}</h4>
      <div class="d-flex gap-2">
        <a href="{{ route('catalog_v1.categories.products',$category->id) }}" class="btn btn-primary">DS sản phẩm</a>
        <a href="{{ route('catalog_v1.categories.index') }}" class="btn btn-danger">Quay lại</a>
      </div>
    </div>
  ...
  <div class="card">
    <div class="card-body">
      <form method="get" class="row" action="{{ route('catalog_v1.categories.attach.page',$category->id) }}">
        ...
        <div class="col-md-4 mb-2">
          ...
          <a class="btn btn-danger" href="{{ route('catalog_v1.categories.attach.page',$category->id) }}">Hủy</a>
        </div>
      </form>

      <form method="post" action="{{ route('catalog_v1.categories.attach',$category->id) }}" id="attachForm">
        @csrf
        ...
        <button class="btn btn-primary">Thêm vào danh mục</button>
      </form>
