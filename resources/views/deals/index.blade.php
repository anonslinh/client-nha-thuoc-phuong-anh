            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="d-sm-flex align-items-center justify-space-between">
                        <h4 class="mb-4 mb-sm-0 card-title">Deal chớp nhoáng</h4>
                                ...
                                <td>
                                    <div class="modal fade" id="modalUpdate{{$value->id}}" tabindex="-1" aria-labelledby="vertical-center-modal" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <form action="{{route('deal.update-deal',$value->id)}}" method="post" class="modal-content" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group mb-2">
                                                        <label class="form-label">Giảm giá % (nếu có)</label>
                                                        <input class="form-control" name="discount" value="{{$value->discount}}" >
                                                    </div>
                                                    <div class="form-group mb-2">
                                                        <label class="form-label">Giá cố định (nếu có)</label>
                                                        <input class="form-control" name="fixed_price" value="{{$value->fixed_price}}" >
                                                    </div>
                                                    <div class="form-group mb-2">
                                                        <label class="form-label">Thời gian bắt đầu hiển thị</label>
                                                        <input class="form-control" name="start_time" type="datetime-local" value="{{$value->start_time}}"  required>
                                                    </div>
                                                    <div class="form-group mb-2">
                                                        <label class="form-label">Thời gian kết thúc</label>
                                                        <input class="form-control" name="end_time" type="datetime-local" value="{{$value->end_time}}" required>
                                                    </div>
                                    ...
                                    <a href="{{route('deal.delete-deal',$value->id)}}" class="btn btn-danger btn-sa-confirm">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                                            <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0z"/>
                                            <path d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4zM2.5 3h11V2h-11z"/>
                                        </svg>
                                    </a>
                                    <a href="{{route('deal.index-product-deal', $value->id)}}" class="btn btn-info ">Sản phẩm</a>
                                </td>
                            </tr>
                        @endforeach
                        @else
    ...
    <div class="modal fade" id="modalCreate" tabindex="-1">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('deal.store-deal')}}" method="post" class="modal-content" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group mb-2">
                            <label class="form-label">Tên</label>
                        ...
                        <div class="form-group mb-2">
                            <label class="form-label">Giá cố định (nếu có)</label>
                            <input class="form-control" name="fixed_price" >
                        </div>
                        <div class="form-group mb-2">
                            <label class="form-label">Thời gian bắt đầu hiển thị</label>
                            <input class="form-control" name="start_time" type="datetime-local" required>
                        </div>
                        <div class="form-group mb-2">
                            <label class="form-label">Thời gian kết thúc</label>
                            <input class="form-control" name="end_time" type="datetime-local" required>
                        </div>
                        <div class="mb-3">
                            <label for="status" class="form-label">Trạng thái</label>
                            <select name="status" class="form-control">
