                    ...
                    @if($listData->total() > 0)
                        @foreach($listData as $key => $value)
                            <tr>
                                ...
                                <td><input value="{{$value->redirect_url}}" style="max-width: 200px" class="form-control"></td>
                                            ...
                                            <form action="{{route('banner.update',$value->id)}}" method="post" class="modal-content" enctype="multipart/form-data">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group mb-2">
                                                        ...
                                                        <input class="form-control" name="time_start" value="{{date_format(date_create($value->start_date), 'Y-m-d')}}" type="date" required>
                                                    </div>
                                                    <div class="form-group mb-2">
                                                        <label>Thời gian kết thúc</label>
                                                        <input class="form-control" name="time_end" value="{{date_format(date_create($value->end_date), 'Y-m-d')}}" type="date" required>
                                                    </div>
                                                </div>
