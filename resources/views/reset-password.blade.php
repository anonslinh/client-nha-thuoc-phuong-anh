                ...
                <div class="col-lg-6 col-xl-5 col-xxl-4">
                    <div class="min-vh-100 bg-body row justify-content-center align-items-center p-5">
                        <div class="col-12 auth-card">
                            ...
                            <h2 class="mb-2 mt-4 fs-7 fw-bolder">Đặt lại mật khẩu</h2>
                            @if (session('success'))
                        ...
                        <!-- Hiển thị lỗi validate -->
                            ...
                            <form method="post" action="{{route('password.update')}}">
                                ...
                                <div class="mb-3">
                                    <label>Email</label>
                                    <input type="email" name="email" class="form-control" autocomplete="new-password" required>
                                </div>
                                ...
                                <button type="submit" class="btn btn-primary w-100 py-8 mb-4 rounded-2">Đổi mật khẩu</button>
                            </form>
                        </div>
                    </div>
                </div>
