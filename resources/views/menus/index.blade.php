...
<div class="container-fluid">
    ...
    <div class="row align-items-center">
      <div class="col-12">
        <div class="d-sm-flex align-items-center justify-space-between">
          <h4 class="mb-4 mb-sm-0 card-title">Quản lý Thực đơn</h4>
  ...
  <div class="card mb-3">
    <div class="card-body">
      <form class="row g-2" method="get" action="{{ route('menus.listDataMenus') }}">
        <div class="col-md-3">
        ...
        <div class="col-md-3">
          <input name="kw" class="form-control" value="{{ request('kw') }}" placeholder="Tìm theo tên món">
        </div>
    ...
    <div class="card-body">
      <div class="table-responsive">
        <table class="table table-bordered text-nowrap align-middle">
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    @if($value->image)
                      <img src="{{ $value->image }}" class="rounded-2" width="72" height="54" style="object-fit:cover;">
                    @else
                    ...
                    <div class="ms-3">
                      ...
                      <small class="text-muted">{{ $value->image }}</small>
                    </div>
                  </div>
                </td>
                <td>{{ $roomName }}</td>
                ...
                <td>
                  ...
                  <div class="modal fade" id="modalUpdate{{ $value->id }}" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                      <form action="{{ route('menus.updateMenu', $value->id) }}" method="post" class="modal-content" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-header d-flex align-items-center">
                          <h4 class="modal-title">Cập nhật món thực đơn</h4>
                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-group mb-2">
                            ...
                            @if($value->image)
                              <img src="{{ $value->image }}" class="rounded-2" style="width:200px;object-fit:cover;margin-bottom:8px;">
                            @endif
                            <input class="form-control mb-2" type="file" accept="image/*" name="image">
                            <small class="text-muted d-block">Hoặc nhập URL ảnh dưới đây</small>
                            <input class="form-control" name="image_url" value="{{ $value->image }}" placeholder="https://...">
                          </div>
                  ...
                  <a href="{{ route('menus.deleteMenu', $value->id) }}" class="btn btn-danger btn-sa-confirm">
          ...
          @else
            <tr>
              <td colspan="6"><p class="m-0 text-danger text-center">Không có dữ liệu</p></td>
            </tr>
          @endif
          </tbody>
        </table>
...
<div class="modal fade" id="modalCreate" tabindex="-1">
  <div class="modal-dialog" role="document">
    <form action="{{ route('menus.storeMenu') }}" method="post" class="modal-content" enctype="multipart/form-data">
      @csrf
      <div class="modal-header d-flex align-items-center">
        <h4 class="modal-title">Thêm món thực đơn</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="form-group mb-2">
