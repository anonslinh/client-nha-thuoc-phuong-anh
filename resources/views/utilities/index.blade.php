...
<div class="container-fluid">
    ...
    <div class="row align-items-center">
      <div class="col-12">
        <div class="d-sm-flex align-items-center justify-space-between">
          <h4 class="mb-4 mb-sm-0 card-title">Quản lý Tiện ích</h4>
  ...
  <div class="card mb-3">
    <div class="card-body">
      <form class="row g-2" method="get" action="{{ route('utilities.listDataUtilities') }}">
        <div class="col-md-3">
        ...
        <div class="col-md-3">
          <input name="kw" class="form-control" value="{{ request('kw') }}" placeholder="Tìm theo tên tiện ích">
        </div>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    @if($value->icon)
                      <img src="{{ $value->icon }}" class="rounded-2" width="48" height="48" style="object-fit:cover;">
                    @else
                      <div class="rounded-2 bg-light d-flex align-items-center justify-content-center" style="width:48px;height:48px;">N/A</div>
                    @endif
                    <div class="ms-3">
                ...
                <td>
                  ...
                  <div class="modal fade" id="modalUpdate{{ $value->id }}" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                      <form action="{{ route('utilities.updateUtility', $value->id) }}" method="post" class="modal-content" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-group mb-2">
                            <label class="d-block form-label">Icon hiện tại</label>
                            @if($value->icon)
                              <img src="{{ $value->icon }}" class="rounded-2" style="width:120px;object-fit:cover;margin-bottom:8px;">
                            @endif
                            <input class="form-control mb-2" type="file" accept="image/*" name="icon_file">
                            <small class="text-muted d-block">Hoặc nhập URL icon</small>
                            <input class="form-control" name="icon_url" value="{{ $value->icon }}" placeholder="https://...">
                          </div>

                          <div class="form-group mb-2">
                            <label class="form-label">Mô tả ngắn</label>
                            <input class="form-control" name="short_desc" value="{{ $value->short_desc }}">
                          </div>
                        </div>
                  ...
                  <a href="{{ route('utilities.deleteUtility', $value->id) }}" class="btn btn-danger btn-sa-confirm">
...
<div class="modal fade" id="modalCreate" tabindex="-1">
  <div class="modal-dialog" role="document">
    <form action="{{ route('utilities.storeUtility') }}" method="post" class="modal-content" enctype="multipart/form-data">
      @csrf
      <div class="modal-header d-flex align-items-center">
      ...
      <div class="modal-body">
        ...
        <div class="alert alert-info py-2">
          Bạn có thể <b>upload icon</b> HOẶC nhập <b>URL icon</b>. Nếu có cả hai, hệ thống ưu tiên file upload.
        </div>

        <div class="form-group mb-2">
          <label class="form-label">Upload icon</label>
          <input class="form-control" type="file" accept="image/*" name="icon_file">
        </div>

        <div class="form-group mb-2">
          <label class="form-label">URL icon</label>
          <input class="form-control" name="icon_url" placeholder="https://...">
        </div>
