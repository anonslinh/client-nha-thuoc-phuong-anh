...
@section('content')
    <div class="container-fluid">
                                ...
                                <li class="breadcrumb-item d-flex align-items-center">
                                    @if(count($rule_rotation))
                                        <button type="button" data-bs-toggle="modal" data-bs-target="#modalCreate"
                                                class="justify-content-center badge fw-medium fs-2 btn btn-rounded btn-danger d-flex align-items-center">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('rotation.sub-gift')}}" method="get" class="d-flex align-items-center justify-content-end">
                    ...
                    <a href="{{route('rotation.sub-gift')}}" class="btn btn-danger">Hủy</a>
                </form>
                <div class="mt-4">
                                    ...
                                    <td class="align-middle">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="">
                                                <li>
                                                    <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modalUpdate{{$value->id}}">Sửa</button>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item btn-sa-confirm" href="{{route('rotation.sub-gift.delete',$value->id)}}">Xóa</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="modal fade" id="modalUpdate{{$value->id}}" tabindex="-1">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('rotation.update-gift-2', $value->id) }}" method="post" enctype="multipart/form-data" class="modal-content">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <label for="title" class="form-label">Tên quà:</label>
                                                                <input type="text" value="{{$value->title}}" class="form-control" name="title" required/>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="link" class="form-label">Mã quà:</label>
                                                                <input type="text" value="{{$value->code}}" class="form-control" name="code" required/>
                                                            </div>
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="number" value="{{$value->quantity}}" class="form-control" name="quantity" required/>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="link" class="form-label">Tỷ lệ chúng thưởng: (Lưu ý: Tổng tỉ lệ chúng quà phải là 100%)</label>
                                                                <input type="number" value="{{$value->percent * 100}}" class="form-control" name="percent" required/>
                                                            </div>
                                                            <div class="mb-3">
    ...
    <div class="modal fade" id="modalCreate" tabindex="-1">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('rotation.create-gift-2') }}" method="post" enctype="multipart/form-data" class="modal-content">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="title" class="form-label">Tên quà:</label>
