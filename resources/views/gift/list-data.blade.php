...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('gift.index')}}" method="get" class="row">
                ...
                <form action="{{route('gift.import')}}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-4 mb-2">
                        <input name="file" type="file" accept=".xls,.xlsx" class="form-control" required>
                    </div>
                    <div class="col-md-4 mb-2">
