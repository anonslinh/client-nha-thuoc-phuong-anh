            ...
            <div class="mini-nav">
                ...
                <ul class="mini-nav-ul" data-simplebar>
                    ...
                    <li class="mini-nav-item" id="mini-1">
                        <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-custom-class="custom-tooltip" data-bs-placement="right" data-bs-title="Quà tặng">
                    ...
                    <li class="mini-nav-item" id="mini-3">
                        <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-custom-class="custom-tooltip" data-bs-placement="right" data-bs-title="Banner">
                    ...
                    <li class="mini-nav-item" id="mini-4">
                        <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-custom-class="custom-tooltip" data-bs-placement="right" data-bs-title="Voucher">
...
{{--                    </li>--}}
                    ...
                    <li class="mini-nav-item" id="mini-5">
                        <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-custom-class="custom-tooltip" data-bs-placement="right" data-bs-title="Chương trình">
...
{{--                        </li>--}}
                ...
                <nav class="sidebar-nav scroll-sidebar" id="menu-right-mini-3" data-simplebar>
                    <ul class="sidebar-menu" id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a href="{{route('banner.list-data')}}" class="sidebar-link">
...
{{--                        </li>--}}
                        ...
                        <ul class="sidebar-menu" id="sidebarnav">
                            ...
                            <li class="sidebar-item">
                                <a href="../main/form-repeater.html" class="sidebar-link">
                                    ...
                                    <span class="hide-menu">KH sử dụng voucher</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <nav class="sidebar-nav scroll-sidebar" id="menu-right-mini-5" data-simplebar>
                    <ul class="sidebar-menu" id="sidebarnav">
                        ...
                        <!-- ---------------------------------- -->
                        <li class="nav-small-cap">
                            <span class="hide-menu">Chương trình</span>
                        </li>
                        <!-- ---------------------------------- -->
                        <!-- Dashboard -->
                        <!-- ---------------------------------- -->
                        ...
                        <li class="sidebar-item">
                            <a href="{{route('program.list-data')}}" class="sidebar-link">
