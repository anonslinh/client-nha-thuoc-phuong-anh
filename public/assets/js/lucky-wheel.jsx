...
const API = {
    exchangeGift: () => baseUrl + "api/rotation/exchange-gift-sub",
    getListGift:()=> baseUrl + "api/rotation/list-gift-sub"
}
...
const AppContext = React.createContext({
    phoneUser: queryParams.get("money"),
})
...
function App() {
    ...
    const queryParams = new URLSearchParams(window.location.search);
    useEffect(()=>{
        if(queryParams.get("money")){
            setPhoneUser(queryParams.get("money"))
            setShowLogin(false)
        }
    },[queryParams])
    const getGift = () => {
    ...
    const getListGift = async () => {
        try {
            ...
            formData.append('money', phoneUser)
    ...
    const login = () => {
        setShowLogin(true);
        // setPhoneUser(money);
        window.location.href = window.location.origin + "/lucky-wheel?money=" + money;
    };
            ...
            <div className="py-4 flex flex-col items-center justify-center">
                ...
                <div className="w-full flex flex-col items-center mt-6 justify-center">
                    <button
                        ...
                        onClick={() =>startSpin()}
                    >
                        <span className="text-base font-bold text-white uppercase">Quay</span>
                    </button>
                </div>
            </div>
                        ...
                        >
                            ...
                            <div className="px-2 w-full ">
                                ...
                                <div className="bg-white p-2 w-full rounded-md">
                                    ...
                                    <label  className="text-sm text-gray-60">Giá trị hóa đơn </label>
                                    <input type="text" id="first_name"
                                           ...
                                           placeholder="Vui lòng nhập giá trị hóa đơn   " />
